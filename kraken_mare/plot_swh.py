...
def plot_swh(plabel,**kwargs):
    ...
    swh=significant_wave_height(f,nodes.ac2)
    ...
    dm=pyplot.tripcolor(triangulation,val,shading='flat',vmax=val.max()*1.1,vmin=0,cmap="jet")
    ...
    pyplot.savefig(plabel+"_swh.png")
